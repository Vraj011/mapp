...
import { ProductDropdownMenuDemo } from "./DropAdd_Tag";
...
function Product_Table() {
    ...
    return (
        <>
            ...
            <hr />
            {/* <div className="flex  grid justify-items-stretch"> */}
            <div className=" mx-5 mt-5 mb-3 flex  justify-between    ">
                <Breadcrumb>
                    <BreadcrumbList>
                        <BreadcrumbItem>
                            <BreadcrumbLink>Product Tag</BreadcrumbLink>
                        </BreadcrumbItem>
                        <BreadcrumbSeparator />
                        <BreadcrumbItem>
                            <BreadcrumbLink className="text-black" >Product Tag</BreadcrumbLink>
                                    ...
                                    {paginationProduct.map((item) => (
                                        ...
                                        <TableRow>
                                            ...
                                            <TableCell className="flex justify-center" >
                                                <HoverCard >
                                                    <HoverCardTrigger>
                                                        <HiOutlineDotsVertical className="  btn bg-gray-200 text-gray-500 rounded-sm w-8 h-7" />
                                                    </HoverCardTrigger>
                                                    <HoverCardContent className=" bg-white border-2 px-2 rounded-md w-40  text-center ">
                                                        <span className="flex cursor-pointer  h-10 pt-2 font-medium rounded-sm"><LuPencil className="text-blue-500 mt-1" /> Edit Product Tag</span>
                                                        <span className="flex cursor-pointer h-10 pt-2 font-medium rounded-sm" onClick={handleDeleteItem} > <BiTrash className="text-red-500  mt-1" />Delete Product Tag</span>
                                                    </HoverCardContent>
                        ...
                        <DialogContent className="sm:max-w-[425px]">
                            ...
                            <form onSubmit={handleAddNew} className="mb-5 ms-3">
                                <div className="grid gap-4">
                                    ...
                                    <div className="grid ">
                                        <Label htmlFor="text">Tag Group</Label>
                                        {/* <Input id="text" name="text" defaultValue="Text" /> */}
                                        <ProductDropdownMenuDemo />
                                    </div>
                                </div>
                                <DialogFooter>
                                    <DialogClose asChild>
                                        ...
                                        <HoverCard >
                                            ...
                                            <HoverCardContent className=" bg-white px-2 border-2 rounded-md w-40  text-center ">
                                                ...
                                                <span className="flex cursor-pointer h-10 pt-2 font-medium rounded-sm" onClick={() => handleEditClick(idx)}>
                                                    <LuPencil className="text-blue-500 mt-1" /> Edit Product Tag
                                                </span>
