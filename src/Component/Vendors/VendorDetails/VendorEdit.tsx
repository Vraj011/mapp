...
function VendorEdit() {
    ...
    useDocumentTitle('Edit_Details | Vendor')

    const navigate = useNavigate()
    const handleNext = () => {
        navigate("/vendorFilter_edit")
    }
    const handleVendor = () => {
        navigate("/vendor")
    }
    ...
    const handleContact = () => {
        navigate("/vendorContact_edit")
    }
    const [editName, setEditName] = useLocalstorage("Editnames", "")
    ...
    useEffect(() => {
        const vendorData = localStorage.getItem("editVendor")
        if (vendorData) {
                ...
                <div className=" mx-5 mt-5 mb-3 flex  justify-between">
                    <Breadcrumb>
                        <BreadcrumbList>
                            ...
                            <BreadcrumbSeparator />
                            <BreadcrumbItem>
                                <BreadcrumbLink href='/vendor' >Vendor</BreadcrumbLink>
                            </BreadcrumbItem>
                            <BreadcrumbSeparator />
                            <BreadcrumbItem>
                                <BreadcrumbLink className="text-black">Edit</BreadcrumbLink>
                            </BreadcrumbItem>
                        </BreadcrumbList>
                    </Breadcrumb>
                ...
                <div className=' grid grid-cols-7 gap-3 '>
                    <div className=" bg-white px-2 ms-2 rounded-md col-span-1 shadow-md border-2 border-gray-300">
                        ...
                        <div>
                            ...
                            <p
                                className={`flex rounded-sm px-2 py-2 mb-3 cursor-pointer ${activeSection === "filter" ? "bg-blue-500 text-white" : formCompleted ? "text-gray-500 cursor-not-allowed" : "hover:bg-blue-500 hover:text-white"}`}
                        ...
                        <form className=' mx-5 '
                            ...
                            <div className=" mt-5  gap-5 justify-around w-full text-2xl h-50   items-center ">
                                ...
                                <div>
                                    ...
                                    <Textarea placeholder='Note' className='border-2'></Textarea>
                                </div>
                            </div>
                            <div>
                                <Label className='text-sm font-medium mb-1'>Minimum Order Amount</Label>
                            ...
                            <div className='flex justify-end mb-5'>
                                <Button variant="blue"
                                    type='submit'
                                    className='flex justify-end' disabled={!editName} >Next</Button>
