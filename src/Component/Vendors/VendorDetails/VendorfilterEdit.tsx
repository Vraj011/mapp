...
// function VendorEDIfilterEdit() {
//     return (
//         <div>VendorEDIfilterEdit</div>
//     )
// }

// export default VendorEDIfilterEdit
...
function VendorEDIfilterEdit() {
    ...
    useDocumentTitle('Edit_EDIfilter | Vendor')
                        ...
                        <form className=' mx-5 ' onSubmit={handleSubmit}>
                            ...
                            <div className=" mt-5  gap-5 justify-around w-full text-2xl h-50   items-center ">
                                ...
                                <div className='mt-10 mb-5'>
                                    ...
                                    <Textarea placeholder='Enter excluded vendor part number which will ignored by EDI processing. One per line. ' className='border-2'></Textarea>
                                </div>


                                <div className='mt-10 '>
                                    <Label className=' text-sm font-medium mb-1'>Excluded Auto EDI Accounts</Label>
                                    <Textarea placeholder='Enter excluded vendor account number which will ignored by EDI processing. One per line. ' className='border-2'></Textarea>
                                </div>
