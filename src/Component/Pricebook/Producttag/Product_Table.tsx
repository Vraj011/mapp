...
import type { ProductData } from "./Product_Form"


interface Props {
    prtTableData: ProductData[] | any,

}

function Product_Table({ prtTableData }: Props) {
                ...
                <div className=" mt-5 mx-5 mb-5">
                    ...
                    <Table>
                        <TableHeader className="bg-base-300 text-center border-1 border-gray-300">
                            ...
                            <TableHead className="text-center text-gray-500 border-r-1  border-gray-300 ">Tag</TableHead>
                        ...
                        <TableBody>
                            {prtTableData.filter((items: any) => items.name.toLocaleLowerCase().includes(searchText.toLocaleLowerCase()))
                                // {/* {prtTableData */}
                                .map((item: any, idx: number) => (
                                    ...
                                    <TableRow key={idx}>
                                        ...
                                        <TableCell className="text-center text-gray-600 border-r-1 border-b-1 border-gray-300 ">{item.tag}</TableCell>
